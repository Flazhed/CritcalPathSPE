...
public class Graph {
    ...
    public void criticalPath() {
        ...
        for (Edge e : edges) {
            ...
            if (tempChild.getLateFinish() == tempChild.getEarlyFinish() && tempParent.getLateFinish() == tempParent.getEarlyFinish())
                critcalEdges.add(e);
        }
        ...
        System.out.print("The criticalpath: " + lowEdge.getParentNode().getName());
        while (lowEdge != null) {
